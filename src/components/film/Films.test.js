...
describe('Composant Film', () => {
    ...
    //  sur mokeFilm faire la poutine pour trouver la moyenne et le nombre de notes 
    // render le composant vote avec sa/ses propos 

    // sur screen toBeInTheDocument
    render(< Vote handleClick={soumettreNote} moyenne={moyenne} nombreVotes={nombreVotes} />);
    expect(moyenne).toBeInTheDocument();
    expect(nombreVotes).toBeInTheDocument();
